...
> **For Claude:** REQUIRED SUB-SKILL: Use agent-powerups:executing-plans to implement this plan task-by-task.
...
- **REQUIRED SUB-SKILL:** Use agent-powerups:subagent-driven-development
